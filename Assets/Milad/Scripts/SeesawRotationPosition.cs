...
public class SeesawRotationPosition : MonoBehaviour
{
    ...
    public void LeftUp(float temp)
    {
       if (temp > 0f && temp <= 90f)
       {
            puppetConterollerLeft.transform.localPosition = new Vector3(vrConterollerLeftOrRight.transform.localPosition.x-1, temp / leftAngle, vrConterollerLeftOrRight.transform.localPosition.z);
            puppetConterollerRight.transform.localPosition = new Vector3(vrConterollerLeftOrRight.transform.localPosition.x+1, -temp / leftAngle, vrConterollerLeftOrRight.transform.localPosition.z);
        //Debug.Log("LeftUp");
       }
    }
    public void RightUp(float temp)
    {
        ...
        {
          temp -= 360f;
            puppetConterollerLeft.transform.localPosition = new Vector3(vrConterollerLeftOrRight.transform.localPosition.x-1, -temp / rightAngle, vrConterollerLeftOrRight.transform.localPosition.z);
            puppetConterollerRight.transform.localPosition = new Vector3(vrConterollerLeftOrRight.transform.localPosition.x+1, temp / rightAngle, vrConterollerLeftOrRight.transform.localPosition.z);
          //Debug.Log("RightUp");
        }
    }
